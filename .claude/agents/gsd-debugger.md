...
<required_reading>
@D:/CODES/Trionix Projects/companion/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/CODES/Trionix Projects/companion/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/CODES/Trionix Projects/companion/.claude
                  → checks D:/CODES/Trionix Projects/companion/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/CODES/Trionix Projects/companion/.claude/get-shit-done
                  → writes to D:/CODES/Trionix Projects/companion/.claude/get-shit-done/hooks/
...
@D:/CODES/Trionix Projects/companion/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/CODES/Trionix Projects/companion/.claude/get-shit-done/references/common-bug-patterns.md
