...
INSTALL_JS_GLOBAL="D:/CODES/Trionix Projects/companion/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/CODES/Trionix Projects/companion/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
