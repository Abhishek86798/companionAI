...
```bash
INIT=$(node "D:/CODES/Trionix Projects/companion/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/CODES/Trionix Projects/companion/.claude/get-shit-done/templates/spec.md.
