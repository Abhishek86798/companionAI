...
<template>
@D:/CODES/Trionix Projects/companion/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/CODES/Trionix Projects/companion/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/CODES/Trionix Projects/companion/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @D:/CODES/Trionix Projects/companion/.claude/get-shit-done/workflows/diagnose-issues.md
