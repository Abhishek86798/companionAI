...
<required_reading>
@D:/CODES/Trionix Projects/companion/.claude/get-shit-done/references/ai-frameworks.md
@D:/CODES/Trionix Projects/companion/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/CODES/Trionix Projects/companion/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/CODES/Trionix Projects/companion/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/CODES/Trionix Projects/companion/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/CODES/Trionix Projects/companion/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/CODES/Trionix Projects/companion/.claude/agents/gsd-eval-planner.md for instructions.
