...
Key references:
- @D:/CODES/Trionix Projects/companion/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @D:/CODES/Trionix Projects/companion/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/CODES/Trionix Projects/companion/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/CODES/Trionix Projects/companion/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/CODES/Trionix Projects/companion/.claude/get-shit-done/USER-PROFILE.md" "D:/CODES/Trionix Projects/companion/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/CODES/Trionix Projects/companion/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/CODES/Trionix Projects/companion/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @D:/CODES/Trionix Projects/companion/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/CODES/Trionix Projects/companion/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/CODES/Trionix Projects/companion/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/CODES/Trionix Projects/companion/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/CODES/Trionix Projects/companion/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/CODES/Trionix Projects/companion/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/CODES/Trionix Projects/companion/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    D:/CODES/Trionix Projects/companion/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/CODES/Trionix Projects/companion/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/CODES/Trionix Projects/companion/.claude/CLAUDE.md
```
