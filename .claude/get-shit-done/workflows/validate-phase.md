...
```
Agent(
  prompt="Read D:/CODES/Trionix Projects/companion/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/CODES/Trionix Projects/companion/.claude/get-shit-done/templates/VALIDATION.md`
