...
```markdown
Read D:/CODES/Trionix Projects/companion/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/CODES/Trionix Projects/companion/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/CODES/Trionix Projects/companion/.claude/agents/gsd-ui-checker.md for instructions.
