...
- Usage: Reference from command with `@D:/CODES/Trionix Projects/companion/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/CODES/Trionix Projects/companion/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/CODES/Trionix Projects/companion/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
