...
- Usage: Reference from command with `@D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/CODES/Trionix Projects/companion/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/CODES/Trionix Projects/companion/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
