...
<required_reading>
@D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/references/user-story-template.md
@D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/references/spidr-splitting.md
@D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/references/spidr-splitting.md`. Briefly:
