...
Key references:
- @D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/references/ui-brand.md (display patterns)
- @D:/CODES/Trionix Projects/companion/.cursor/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/USER-PROFILE.md" "D:/CODES/Trionix Projects/companion/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/references/user-profiling.md`
...
Reference: @D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to D:/CODES/Trionix Projects/companion/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/CODES/Trionix Projects/companion/.cursor/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/CODES/Trionix Projects/companion/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="D:/CODES/Trionix Projects/companion/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/CODES/Trionix Projects/companion/.cursor/skills/gsd-dev-preferences/SKILL.md
  ✓ .cursor/rules/ section       .cursor/rules/
  ✓ Global .cursor/rules/        D:/CODES/Trionix Projects/companion/.cursor/.cursor/rules/
```
