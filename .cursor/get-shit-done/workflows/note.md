...
- **Global scope**: `D:/CODES/Trionix Projects/companion/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/CODES/Trionix Projects/companion/.cursor/notes/`)
...
2. Glob `D:/CODES/Trionix Projects/companion/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (D:/CODES/Trionix Projects/companion/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/CODES/Trionix Projects/companion/.cursor/notes/` — works in any directory
