...
```
Agent(
  prompt="Read D:/CODES/Trionix Projects/companion/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/templates/VALIDATION.md`
