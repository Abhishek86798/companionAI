...
```bash
INIT=$(node "D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/bin/gsd-tools.cjs" commit \
