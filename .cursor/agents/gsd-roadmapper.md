...
Reference full template: `D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/templates/state.md`.
