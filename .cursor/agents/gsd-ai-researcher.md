...
<required_reading>
Read `D:/CODES/Trionix Projects/companion/.cursor/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
